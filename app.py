...
def PersistVersion():
    pc_version = constants.GAME_VERSION
    android_version = constants.GAME_VERSION

    data = {
        "maintenance_mode": "yes" if maintenance else "no",
        "message": "Card Wars Kingdom is currently undergoing maintenance.\n\nPlease try again later.",
        "icon": "https://png.pngtree.com/element_our/20190601/ourmid/pngtree-file-download-icon-image_1344466.jpg",
        "clickable": "yes",
        "android_version": android_version,
        "version": pc_version,
        "android_url": "https://github.com/ThugRod/Card-Wars-Kingdom/releases/download/" + constants.GAME_VERSION +"/CardWarsKingdoms-v" + constants.GAME_VERSION + "Android.apk",
        "pc_url": "https://github.com/ThugRod/Card-Wars-Kingdom/releases/download/v" + constants.GAME_VERSION + "/Card.Wars.Kingdom-v" + constants.GAME_VERSION + "-PC.zip",
    }
